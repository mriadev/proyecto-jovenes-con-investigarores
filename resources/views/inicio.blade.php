...
<main>
    ...
    <section id='inicio-up'>
        ...
        <section id="inicio-videos">
            ...
            <div id="video-line-1">
                <iframe width="560" height="315" src=@php echo $videos[0]->url @endphp
            ...
            <div id="video-line-2">
                <iframe width="280" height="158" src=@php echo $videos[1]->url @endphp
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;
                    web-share"
                    allowfullscreen></iframe>
                <iframe width="280" height="158" src=@php echo $videos[2]->url @endphp
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;
                    web-share"
                    allowfullscreen></iframe>
