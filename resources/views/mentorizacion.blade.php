...
<main id="main-mentorizacion">
    ...
    <section class="container">
        ...
        @if(Auth::guest() || (Auth::user()->join('perfiles', 'users.perfil_id', '=', 'perfiles.id')->where('perfiles.perfil', 'mentor')->count() == 0
                    ...
                    <form class="form-body" action="{{ route('mentorizacion') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" name="nombre-completo" value="{{ Auth::user()->nombre }} {{ Auth::user()->apellidos }}">
                            </div>
                        </div>
                        <!-- correo -->
                        <div class="row">
